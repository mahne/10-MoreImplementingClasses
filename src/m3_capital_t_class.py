...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def clone(self):
        ...
        #######################################################################
        t = CapitalT(self.h_rect.get_center(),self.h_rect.get_upper_right_corner().x-self.h_rect.get_upper_left_corner().x,self.v_rect.get_lower_left_corner().y-self.v_rect.get_upper_left_corner().y,self.v_rect.get_lower_right_corner().x-self.v_rect.get_lower_left_corner().x)
        ...
        t.h_rect.fill_color = self.v_rect.fill_color
        return t
